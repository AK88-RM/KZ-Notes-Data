...
## Enable Trust access to the VBA project object model
shell(shQuote(normalizePath("C:/Users/user.userov/Documents/Notes/2010/VBS1.vbs")), "cscript", flag = "//nologo")

getwd()
setwd("C:/Users/user.userov/Documents/Notes/2010")
...
instruments = instruments[-12, ]  ## there is no page for NTK091_1221
...
dt = dt[-12, ]  ## there is no page for NTK091_1221
nwd = merge(dt, wide, by = "Code")
nwd

write.csv(nwd, "nwd2010.csv")
